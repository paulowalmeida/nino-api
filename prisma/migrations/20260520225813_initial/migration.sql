...
-- CreateIndex
CREATE UNIQUE INDEX "customer_notification_preferences_customer_id_notification__key" ON "customer_notification_preferences"("customer_id", "notification_type_id");
