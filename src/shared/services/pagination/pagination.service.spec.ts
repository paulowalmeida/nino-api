...
describe('PaginationService', () => {
  ...
  describe('wrap', () => {
    it('should return data and pagination together', () => {
      const result = service.paginate(['a', 'b'], 2, { page: 1, limit: 20 })
