...
describe(NotificationTypeService.name, () => {
  ...
  it('getAll() should return notification types array', async () => {
  ...
  it('getById() should return notification type by id', async () => {
  ...
  it('create() should create new notification type', async () => {
  ...
  it('create() should throw ConflictException if name exists', async () => {
    ...
    await expect(service.create({ name: 'EMAIL' })).rejects.toThrow(
      ConflictException,
    )
  })

  it('update() should update notification type', async () => {
  ...
  it('update() should throw ConflictException if new name exists', async () => {
    ...
    await expect(service.update('uuid-1', { name: 'SMS' })).rejects.toThrow(
      ConflictException,
    )
  })

  it('delete() should remove notification type', async () => {
